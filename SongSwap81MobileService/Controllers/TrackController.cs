...
using SongSwap81MobileService.DataObjects;
using SongSwap81MobileService.Models;

namespace SongSwap81MobileService.Controllers
{
    public class TrackController : TableController<Track>
    {
        protected override void Initialize(HttpControllerContext controllerContext)
        {
            ...
            DomainManager = new EntityDomainManager<Track>(context, Request, Services);
        }
